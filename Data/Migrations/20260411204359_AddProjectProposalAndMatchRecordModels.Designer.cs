...
namespace BlindMatchPAS.Data.Migrations
{
    ...
    [Migration("20260411204359_AddProjectProposalAndMatchRecordModels")]
    partial class AddProjectProposalAndMatchRecordModels
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BlindMatchPAS.Models.MatchRecord", b =>
                {
                    b.HasOne("BlindMatchPAS.Models.ProjectProposal", "ProjectProposal")
                        .WithOne("MatchRecord")
                        .HasForeignKey("BlindMatchPAS.Models.MatchRecord", "ProposalId")
