        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Abstract = table.Column<string>(type: "nvarchar(max)", maxLength: 8000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    SupervisorId = table.Column<string>(type: "nvarchar(450)", maxLength: 450, nullable: false),
                    ResearchAreaId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectMatches_AspNetUsers_SupervisorId",
                        column: x => x.SupervisorId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ProjectMatches_Proposals_ProposalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectMatches_ProposalId",
                table: "ProjectMatches",
                column: "ProposalId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_ProjectMatches_SupervisorId",
                table: "ProjectMatches",
                column: "SupervisorId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SupervisorResearchAreas_SupervisorId_ResearchAreaId",
                table: "SupervisorResearchAreas",
